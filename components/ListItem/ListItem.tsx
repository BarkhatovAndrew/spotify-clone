...
export const ListItem = (props: ListItemProps) => {
  ...
  return (
    <button className="group relative flex cursor-pointer items-center gap-x-4 overflow-hidden rounded-md bg-neutral-100/10 pr-4 transition hover:bg-neutral-100/20">
