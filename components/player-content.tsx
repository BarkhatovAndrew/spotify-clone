...
export const PlayerContent = (props: PlayerContentProps) => {
  const { songUrl, song } = props
  ...
  return (
    <div className="grid h-full grid-cols-2 md:grid-cols-3">
      ...
      <div className="hidden h-full w-full max-w-[277px] items-center justify-center gap-x-6 md:flex">
        <AiFillBackward
          size={30}
